...
static bool js_pipeline_DeferredPipeline_destroyShadowFrameBuffers(se::State& s)
{
    cc::pipeline::DeferredPipeline* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_destroyShadowFrameBuffers : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
        cobj->destroyShadowFrameBuffers();
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_pipeline_DeferredPipeline_destroyShadowFrameBuffers)
...
static bool js_pipeline_DeferredPipeline_getOrCreateRenderPass(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        cc::gfx::RenderPass* result = cobj->getOrCreateRenderPass(arg0.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_getOrCreateRenderPass : Error processing arguments");
        return true;
    }
...
static bool js_pipeline_DeferredPipeline_getShadowFramebufferMap(se::State& s)
{
    cc::pipeline::DeferredPipeline* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_getShadowFramebufferMap : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_getShadowFramebufferMap : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_pipeline_DeferredPipeline_getShadowFramebufferMap)
...
static bool js_pipeline_DeferredPipeline_setShadowFramebuffer(se::State& s)
{
    cc::pipeline::DeferredPipeline* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_setShadowFramebuffer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
        ok &= sevalue_to_native(args[1], &arg1, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_setShadowFramebuffer : Error processing arguments");
...
SE_BIND_FUNC(js_pipeline_DeferredPipeline_setShadowFramebuffer)
...
static bool js_pipeline_DeferredPipeline_setShadowObjects(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        cobj->setShadowObjects(arg0.value());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
...
static bool js_pipeline_DeferredPipeline_updateCameraUBO(se::State& s)
{
    cc::pipeline::DeferredPipeline* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_updateCameraUBO : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        HolderType<cc::pipeline::Camera*, false> arg0 = {};
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_updateCameraUBO : Error processing arguments");
    ...
    if (argc == 2) {
        ...
        ok &= sevalue_to_native(args[1], &arg1, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_updateCameraUBO : Error processing arguments");
        cobj->updateCameraUBO(arg0.value(), arg1.value());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 2);
    return false;
}
SE_BIND_FUNC(js_pipeline_DeferredPipeline_updateCameraUBO)

static bool js_pipeline_DeferredPipeline_updateGlobalUBO(se::State& s)
{
    cc::pipeline::DeferredPipeline* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_updateGlobalUBO : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_pipeline_DeferredPipeline_updateGlobalUBO)

static bool js_pipeline_DeferredPipeline_updateShadowUBO(se::State& s)
{
    cc::pipeline::DeferredPipeline* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_updateShadowUBO : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        HolderType<cc::pipeline::Camera*, false> arg0 = {};
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_updateShadowUBO : Error processing arguments");
...
SE_BIND_FUNC(js_pipeline_DeferredPipeline_updateShadowUBO)
...
bool js_register_pipeline_DeferredPipeline(se::Object* obj)
{
    ...
    cls->defineFunction("destroyShadowFrameBuffers", _SE(js_pipeline_DeferredPipeline_destroyShadowFrameBuffers));
    ...
    cls->defineFunction("getShadowFramebufferMap", _SE(js_pipeline_DeferredPipeline_getShadowFramebufferMap));
    ...
    cls->defineFunction("setShadowFramebuffer", _SE(js_pipeline_DeferredPipeline_setShadowFramebuffer));
    ...
    cls->defineFunction("updateCameraUBO", _SE(js_pipeline_DeferredPipeline_updateCameraUBO));
    cls->defineFunction("updateGlobalUBO", _SE(js_pipeline_DeferredPipeline_updateGlobalUBO));
    cls->defineFunction("updateShadowUBO", _SE(js_pipeline_DeferredPipeline_updateShadowUBO));
