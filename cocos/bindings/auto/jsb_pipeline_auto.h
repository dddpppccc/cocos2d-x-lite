...
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_destroyShadowFrameBuffers);
...
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_getShadowFramebufferMap);
...
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_setShadowFramebuffer);
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_setShadowObjects);
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_setSkybox);
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_updateCameraUBO);
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_updateGlobalUBO);
SE_DECLARE_FUNC(js_pipeline_DeferredPipeline_updateShadowUBO);
